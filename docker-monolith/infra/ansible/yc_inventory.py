...
with open("./environments/stage/dynamic_inv_output.json", "w") as dynamic_json_file:
    json.dump(dynamic_inventory, dynamic_json_file, indent=4)

# Save the static inventory to a JSON file
with open("./environments/stage/static_inventory.json", "w") as static_json_file:
    json.dump(static_inventory, static_json_file, indent=4)

# Save the dynamic inventory to a JSON file
with open("./environments/prod/dynamic_inv_output.json", "w") as dynamic_json_file:
    json.dump(dynamic_inventory, dynamic_json_file, indent=4)

# Save the static inventory to a JSON file
with open("./environments/prod/static_inventory.json", "w") as static_json_file:
    json.dump(static_inventory, static_json_file, indent=4)
